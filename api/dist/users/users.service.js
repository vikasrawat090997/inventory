...
let UsersService = class UsersService {
    ...
    async onModuleInit() {
        ...
        if (count === 0) {
            const defaultUser = new register_user_dto_1.RegisterUserDto();
    ...
    async login(loginUserDto) {
        ...
        const token = jwt_helper_1.JwtHelper.sign({ id: user.id, username: user.username, pharmacyName: user.pharmacyName });
        return {
            token,
